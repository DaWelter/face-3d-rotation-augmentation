...
if __name__ == '__main__':
    ...
    parser.add_argument("--yaw-step", type=float, default=5.0, help="the increment of yaw angle per sample")
    parser.add_argument(
        "--prob-closed-eyes", type=float, default=0.0, help="probability for closing eyes (between 0 and 1)"
    )
    parser.add_argument(
        "--prob-spotlight",
        type=float,
